...
export function TypewriterEffectSmoothDemo() {
    ...
    return (
        <div className="flex flex-col items-start justify-center h-[40rem] w-[40rem] text-2xl text-wrap">
            ...
            <p> <span className="text-colorMor">Ingeniero Electrónico</span> de Medellín, Colombia. Mi enfoque principal es el desarrollo web 
            ...
            <div className="flex flex-col mt-12 md:flex-row space-y-4 md:space-y-0 space-x-0 md:space-x-4">
                
                <div className="group relative flex justify-center">
                    <a href="mailto:santiagogomezfpv@gmail.com" target="_blank" rel="noopener noreferrer" 
                        className="flex justify-center align-center w-40 h-10 rounded-full bg-black border border-black text-gray-100 text-sm 
                        transition hover:scale-110 hover:bg-black/50 hover:border-gray-100/50">
                        <span className="inline-flex items-center p-2">
                            <svg className="size-5 mr-2 " xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <span class="absolute top-14 scale-0 transition-all rounded-full bg-colorMor/30 px-4 py-2 text-xs text-white group-hover:scale-100 ">
                        santiagogomezfpv@gmail.com
                    </span>
                </div>

                <a href="https://www.linkedin.com/in/santiago-gómez-ortega" target="_blank" rel="noopener noreferrer" 
                    className="flex justify-center align-center w-40 h-10 rounded-full bg-gray-100 border border-gray-100 text-black text-sm 
                    transition hover:scale-110 hover:bg-gray-100/90 hover:border-black hover:border">
                    <span className="inline-flex items-center p-2">
                        <svg className="size-5 mr-2 " width="256" height="250" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 256">
                ...
                <a href="https://github.com/SantiagoGomezfpv" target="_blank" rel="noopener noreferrer" 
                    ...
                    transition hover:scale-110 hover:bg-black/50 hover:border-gray-100/50">
                    <span className="inline-flex items-center p-2">
                        <svg className="size-5 mr-2 " viewBox="0 0 256 250" width="256" height="250" fill="currentColor" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
