            ...
            <div className="flex flex-row mt-6 md:mt-12 space-y-0 space-x-2 ">
                <div className="group relative flex justify-center">
                    <a href="mailto:santiagogomezfpv@gmail.com" target="_blank" rel="noopener noreferrer" 
                        className="flex justify-center align-center md:w-40 h-10 rounded-full bg-black border border-black text-gray-100 text-sm 
                ...
                <a href="https://www.linkedin.com/in/santiago-gómez-ortega" target="_blank" rel="noopener noreferrer" 
                    className="flex justify-center align-center md:w-40 h-10 rounded-full bg-gray-100 border border-gray-100 text-black text-sm 
